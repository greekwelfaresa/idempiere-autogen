...
public class ModelClassGenerator
{
	 ...
	 */
	public ModelClassGenerator (int AD_Table_ID, String directory, String packageName, String entityTypeFilter, String superClass)
	{
		...
		// Header
		String className = createHeader(AD_Table_ID, sb, mandatory, packageName, superClass);
	 ...
	 * 	@return class name
	 */
	private String createHeader (int AD_Table_ID, StringBuilder sb, StringBuilder mandatory, String packageName, String superClass)
	{
		String tableName = "";
		int accessLevel = 0;
		...
		// Use a string here rather than a direct reference to the class so as not to
		// unnecessarily create a runtime dependency on the annotation package.
		addImportClass("au.org.greekwelfaresa.idempiere.autogen.annotation.IDModel");
