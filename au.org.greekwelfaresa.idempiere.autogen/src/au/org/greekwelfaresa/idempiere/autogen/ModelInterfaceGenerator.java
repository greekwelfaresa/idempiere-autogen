...
public class ModelInterfaceGenerator
{
	 ...
	 */
	public ModelInterfaceGenerator(int AD_Table_ID, String directory, String packageName, String entityTypeFilter, String superClass) {
		...
		// Header
		String tableName = createHeader(AD_Table_ID, sb, mandatory, superClass);
	 ...
	 * @return class name
	 */
	private String createHeader(int AD_Table_ID, StringBuilder sb, StringBuilder mandatory, String superClass) {
		String tableName = "";
		int accessLevel = 0;
		...
		start.append("public interface ").append(className);
		
		if (superClass != null) {
			start.append(" extends ").append(superClass).append(" {").append("\n");
		} else {
			start.append(" {").append("\n")
